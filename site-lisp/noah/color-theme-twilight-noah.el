...
(defun color-theme-twilight-noah ()
  ...
  (color-theme-install
	'(color-theme-twilight
	  ...
	  (font-lock-comment-face ((t (:italic t :foreground "#ADA4AE"))))
	  (font-lock-constant-face ((t (:foreground "#CF6A4C"))))
	  (font-lock-doc-string-face ((t (:foreground "DarkOrange"))))
	  (font-lock-function-name-face ((t (:foreground "#C6B031"))))
	  (font-lock-keyword-face ((t (:foreground "#D1D100"))))
